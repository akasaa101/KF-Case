...
describe('GET /site-info/{siteId}', () => {
  it('should return 200 and It should return 200 and the correct site info for siteId "norwich-pear-tree" with a valid api key', async () => {
    const response = await request(server)
      .get('/site-info/norwich-pear-tree')
    ...
    expect(response.body.id).toEqual('norwich-pear-tree')
